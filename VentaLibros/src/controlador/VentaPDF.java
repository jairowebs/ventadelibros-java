...
/**
 *
 *  @author jairo figueroa - © jairowebs
 */
public class VentaPDF {
    ...
    public void generarFacturaPDF() {
        try {
            ...
            String Nit = "0987654321001";
            String nombre = "jairowebs";
            String telefono = "3186415911";
            String direccion = "madrid-col";
            String razon = "desarrollo de software";
